...
def load_darknet_weights(self, weights, cutoff=-1):
    ...
    from_coco_weights = False
    if file == 'darknet53.conv.74':
        cutoff = 75
    elif file == 'yolov3-tiny.conv.15':
        cutoff = 15
    elif file == 'yolov3-tiny.weights' or file == 'yolov3.weights':
        from_coco_weights = True
        print('Loading official COCO darknet weights...')
